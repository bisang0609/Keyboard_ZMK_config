...
- `snake` 관련 실드, keymap, 빌드 타깃, west 의존성은 실기 불안정으로 모두 제거했다.
- 로컬 작업 폴더 정리:
  - `/home/bisang0609/ZMK_Keyboard/build/` 아래 보존 대상만 남기고 임시 빌드 산출물을 삭제했다.
  - `/home/bisang0609/zephyr_supermini_oled_test` 삭제
  - `/home/bisang0609/zephyr_supermini_st7789_test` 삭제
  - `/home/bisang0609/ZMK_Keyboard/firmware_exports` 삭제
  - `/home/bisang0609/ZMK_Keyboard/snake-module` 삭제
...
- 내일 회사 PC에서도 아래 경로가 남아 있으면 동일하게 삭제한다.
  - `~/zephyr_supermini_oled_test`
  - `~/zephyr_supermini_st7789_test`
