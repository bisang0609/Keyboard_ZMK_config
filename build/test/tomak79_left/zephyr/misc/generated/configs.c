...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_RGB_UNDERGLOW_BRT_MAX, 100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_RGB_UNDERGLOW_BRT_START, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_RGB_UNDERGLOW_SPD_START, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_RGB_UNDERGLOW_EFF_START, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_TOMAK79_LEFT, 1);
