...
LOG_MODULE_REGISTER(tomak79_right2_hid_indicators, CONFIG_ZMK_LOG_LEVEL);
...
static int tomak79_right2_hid_indicators_listener(const zmk_event_t *eh) {
...
ZMK_LISTENER(tomak79_right2_hid_indicators_listener, tomak79_right2_hid_indicators_listener);
ZMK_SUBSCRIPTION(tomak79_right2_hid_indicators_listener, zmk_hid_indicators_changed);
